...
parser.add_argument('input', help='input file containing ucomp, vcomp, sphum on pressure levels')
...
uq_int = np.trapz(u * q, x=pres, axis=1)
vq_int = np.trapz(v * q, x=pres, axis=1) 
